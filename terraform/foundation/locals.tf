locals {
  ...
  xray_config_dev_data = var.enable_vpn_dev_stack ? base64encode(local.xray_config_dev_rendered) : ""
  ...
  xray_config_dev_name            = var.enable_vpn_dev_stack ? "xray_config_dev__${substr(sha256(local.xray_config_dev_data), 0, 8)}" : ""
